...
namespace time_warden.Controllers
{
    ...
    public class HomeController : Controller
    {
        public ActionResult Index()
        {
            ...
            var currentShift = dbReader.GetCurrentShift(loggedInUser.UserId); //Get current shift using method in DBReader with userid passed in
        ...
        public ActionResult ClockIn()
        {
            ...
            DBReader dbReader = new DBReader();
            var currentShift = dbReader.GetCurrentShift(loggedInUser.UserId); //Check to see if there is a current shift active
            
            if (currentShift != null && currentShift.ClockOutTime == DateTime.MinValue) //If user has ongoing shift, can't click clockin
            {
        ...
        public ActionResult ClockOut()
        {
            ...
            TempData["SuccessMessage"] = $"Clocked out successfully. Your shift started at {currentShift.ClockInTime:HH:mm:ss} and ended at {DateTime.Now:HH:mm:ss}.";
